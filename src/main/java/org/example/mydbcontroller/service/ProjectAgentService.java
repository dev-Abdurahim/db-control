...
//
//@Service
//public class ProjectAgentService extends AbstractService<ProjectAgentRepository, ProjectAgentMapperOld, ProjectAgentBaseValidator>
//        implements CrudService<ProjectAgentDto, ProjectAgentCreateDto, ProjectAgentUpdateDto, BaseCriteria,String> {
//
//    protected ProjectAgentService(ProjectAgentRepository repository, ProjectAgentMapperOld mapper, ProjectAgentBaseValidator validator) {
...
//        ProjectAgent projectAgent = mapper.t(dto);
//         mapper.toDto(repository.save(projectAgent));
//    }
//
//    @Override
